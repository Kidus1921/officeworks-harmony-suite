    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/meetings" element={<Layout><div className="p-6"><h1 className="text-3xl font-bold">Meetings</h1><p className="text-muted-foreground">Coming soon...</p></div></Layout>} />
